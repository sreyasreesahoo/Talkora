...
const NotificationsPage = () => {
  ...
  const displayedAcceptedRequests = showAllAccepted
    ? acceptedRequests
    : acceptedRequests.slice(0, 10);
  return (
          ...
          <>
            ...
            {acceptedRequests.length > 0 && (
              <section className="space-y-4">
                ...
                <div id="accepted-requests-list" className="space-y-3">
                ...
                {acceptedRequests.length > 10 && (
                  <button
                    className="btn btn-link text-primary mt-2 cursor-pointer"
                    onClick={() => setShowAllAccepted(!showAllAccepted)}
                    aria-expanded={showAllAccepted}
                    aria-controls="accepted-requests-list"
            ...
            {incomingReqs.length === 0 && acceptedRequests.length === 0 && (
